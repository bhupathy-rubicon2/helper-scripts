...
def prepare_output_dirs(prefix='/home/mcw/ML_NAS/Rubicon/SOW2/trainings/cl-8/snowplow/pytorch/results/'):
...
def parse_args():
    ...
    parser.add_argument('--outputDir', type=str, default='/home/mcw/ML_NAS/Rubicon/SOW2/trainings/cl-8/snowplow/pytorch/results/')
...
def main():
    ...
    print(cfg.TEST.MODEL_FILE, cfg.MODEL.NAME)
    ...
    top_y1 = int((20 * frame_height) / 100)
    top_y2 = int((10 * frame_height) / 100)
    top_x1 = int((10 * frame_width) / 100)
    top_x2 = int((10 * frame_width) / 100)
    frame_width_vid = int((frame_width-top_x2) - top_x1)
    frame_height_vid = int((frame_height-top_y2) - top_y1)
    outcap = cv2.VideoWriter('{}/{}_pose.avi'.format(args.outputDir, os.path.splitext(os.path.basename(args.videoFile))[0]),
                             cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), int(skip_frame_cnt), (frame_width_vid, frame_height_vid))
    ...
    while True:
        ...
        #pred_boxes = [[(539, 588), (1540, 827)]]
        pred_boxes = [[(top_x1, top_y1), (frame_width-top_x2, frame_height-top_y2)]]
        image_debug = image_debug[top_y1:frame_height-top_y2, top_x1:frame_width-top_x2]
        image_pose = image_pose[top_y1:frame_height-top_y2, top_x1:frame_width-top_x2]
        then = time.time()
        ...
        for coords in pose_preds:
            ...
            for coord in coords:
                ...
                cv2.circle(image_debug, (x_coord, y_coord), 4, (255, 0, 0), 7)
        ...
        #cv2.imwrite('image_debug.png', image_debug)
